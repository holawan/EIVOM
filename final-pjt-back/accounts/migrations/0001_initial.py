# Generated by Django 3.2.12 on 2022-05-26 20:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, default='media/user/프로필기본.png', null=True, upload_to='thumbnails/user/profile/')),
                ('backdrop', imagekit.models.fields.ProcessedImageField(blank=True, default='media/user/프로필배경기본.png', null=True, upload_to='thumbnails/user/backdrop/')),
                ('introduce', models.CharField(blank=True, max_length=100, null=True)),
                ('birth', models.DateField(blank=True, null=True)),
                ('gender', models.CharField(blank=True, choices=[('남성', '남성'), ('여성', '여성')], max_length=2, null=True)),
